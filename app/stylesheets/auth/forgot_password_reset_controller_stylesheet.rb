class ForgotPasswordResetControllerStylesheet < ApplicationStylesheet
  ...
  def sms_code_field(st)
    text_field st
    st.frame                       = {t: 150}
    st.placeholder                 = "Your password reset code"
  ...
  def resent_btn(st)
    standard_button st
    st.frame = {t: 210, l: 20, fr:20, h: 45}
  end
